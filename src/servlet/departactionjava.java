...
/**
 * Servlet implementation class departactionjava
 */
@WebServlet("/departactionjava")
public class departactionjava extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public departactionjava() {
        super();
...
MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"goverment\\WebContent\\Depart\\";
 ...
 filepath1 = editpath + "\\goverment\\WebContent\\Encrypt\\"+filename;
  ...
  //file decrypted and store into filepath2
		...
		System.out.println(e);
			...
			con=Database.create();
			try {
				PreparedStatement pa=con.prepareStatement("SELECT phash,ahash FROM `contract`.departde`");
		...
		departreport bu=new departreport();
		 bu.setEmail(paramValues.get(0).toString());
		   System.out.println("setFilename:"+paramValues.get(0).toString());
				   ...
				   bu.setFilecontent(filecontent);
				   bu.setEncrypt(encontent);
				   bu.setDecrypt(filecontent);
				   bu.setPhash(prehash);
				   bu.setAhash(aphas);
